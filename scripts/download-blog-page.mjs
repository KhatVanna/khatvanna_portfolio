...
const outDir = path.join(__dirname, "..", "public", "images", "blog-page");
...
const html = await fetchText("https://conax.webflow.io/blog");
fs.writeFileSync(path.join(__dirname, "_blog.html"), html);
