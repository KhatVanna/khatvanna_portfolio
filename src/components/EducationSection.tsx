...
export default function EducationSection() {
  return (
    <section id="education" className="relative z-10 overflow-hidden bg-[#f4f4f4] text-black">
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-5 py-16 md:px-8 md:py-20 lg:px-10 lg:py-24">
        <div className="mb-10 grid grid-cols-1 gap-8 md:mb-14 md:grid-cols-4 md:gap-6">
          <BlurFade delay={0.05} inView direction="up" offset={10}>
          ...
          <div className="md:col-span-2">
            <TextAnimate
              ...
              once
              duration={0.4}
              className="text-[clamp(2.5rem,6vw,4.5rem)] font-semibold leading-[0.95] tracking-[-0.04em]"
              segmentClassName="mr-[0.22em] inline-block"
            >
              Learning path
            </TextAnimate>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:justify-end">
            {SITE.languages.map((lang, i) => (
              <BlurFade key={lang.name} delay={0.15 + i * 0.07} inView direction="up" offset={12}>
                <span className="inline-flex items-center rounded-full border border-black/10 bg-white px-3 py-1.5 text-[11px] font-medium tracking-wide">
                  {lang.name}
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {EDUCATION.map((item, i) => (
            ...
            >
              ...
              >
                <article className="flex h-full min-h-[220px] flex-col justify-between p-6 md:p-7">
