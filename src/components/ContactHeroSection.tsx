    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1600px] flex-1 flex-col px-5 pt-28 pb-10 md:px-8 md:pt-32 md:pb-12 lg:px-10 lg:pt-36">
        <div className="relative flex flex-1 items-center justify-center py-10 md:py-16">
          <h1 className="pointer-events-none absolute inset-x-0 top-1/2 w-full -translate-y-1/2 text-center text-[clamp(3rem,14vw,11rem)] font-semibold leading-[0.85] tracking-[-0.05em] text-black/8 uppercase">
            Contact
        ...
        <div className="mt-auto grid grid-cols-1 gap-10 pt-6 md:grid-cols-4 md:gap-6 md:pt-8">
