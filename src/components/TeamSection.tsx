    ...
    <section id="team" className="relative overflow-hidden bg-[#f4f4f4] text-black">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-5 py-16 md:px-8 md:py-20 lg:px-10 lg:py-24">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4 md:gap-6 lg:gap-8">
          <BlurFade delay={0.05} inView direction="up" offset={10} className="md:col-span-1">
          ...
          <div className="md:col-span-2">
            <TextAnimate
              ...
              once
              duration={0.4}
              className="text-[clamp(2.5rem,6vw,5rem)] font-semibold leading-[0.95] tracking-[-0.04em]"
              segmentClassName="mr-[0.22em] inline-block"
            >
              {KALAPAK.name}
            </TextAnimate>
            <BlurFade delay={0.2} inView direction="up" offset={14}>
          ...
          <BlurFade
            ...
            direction="up"
            offset={14}
            className="flex flex-col justify-between gap-6 md:col-span-1 md:items-end md:text-right"
          >
        ...
        <BlurFade delay={0.2} inView direction="up" offset={16}>
