...
export default function ExperienceSection() {
  return (
    <section id="experience" className="relative z-10 overflow-hidden bg-white text-black">
      <div
        aria-hidden
        ...
        <div className="mb-10 flex items-end justify-between gap-6 border-b border-black/10 pb-6 md:mb-14 md:pb-8">
          <div>
            ...
            <TextAnimate
              ...
              once
              duration={0.4}
              className="text-[clamp(2.75rem,7vw,5.5rem)] font-semibold leading-[0.95] tracking-[-0.04em]"
              segmentClassName="mr-[0.22em] inline-block"
            >
              Experience
            </TextAnimate>
          </div>
          <BlurFade delay={0.2} inView direction="up" offset={10}>
        ...
        <div className="space-y-0">
          {EXPERIENCE.map((item, i) => (
            <BlurFade
              ...
              offset={28}
            >
              <article className="grid grid-cols-1 gap-4 border-b border-black/10 py-8 md:grid-cols-12 md:gap-8 md:py-10">
