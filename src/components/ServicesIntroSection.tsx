    ...
    <section id="services-intro" className="relative overflow-hidden bg-white text-black">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-5 py-20 md:px-8 md:py-28 lg:px-10 lg:py-32">
        <div className="grid grid-cols-1 md:grid-cols-4 md:gap-6 lg:gap-8">
          ...
          <h2 className="max-w-[22ch] text-[clamp(1.85rem,4.2vw,3.5rem)] font-semibold leading-[1.08] tracking-[-0.035em] md:col-span-3">
            <span className="text-black">I specialize in full-stack</span>
            <br />
            <span className="text-black">web &amp; mobile development — </span>
            <span className="text-black/25">
              Python, Laravel, React, Flutter, and leading {SITE.teamName}.
            </span>
          </h2>
        </div>
      </div>
