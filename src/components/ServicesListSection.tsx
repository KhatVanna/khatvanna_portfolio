...
const SERVICES = [
  ...
  },
  {
    ...
    body: "I build comprehensive visual systems that capture the core essence and unique personality of your business.",
  ...
  },
  {
    ...
    body: "I translate high-end designs into high-performance digital products using clean, scalable code.",
  ...
  },
  {
    ...
    body: "I provide the data-driven roadmap necessary to navigate the competitive landscape.",
